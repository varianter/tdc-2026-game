...
type gameEntry struct {
	name     string
	color    color.RGBA
	newScene func(*Assets) Scene
}

var wheelGames = []gameEntry{
	{"Chicken Run", color.RGBA{220, 60, 60, 255}, func(a *Assets) Scene { return NewChickenScene(a) }},
	{"Frogger", color.RGBA{60, 180, 60, 255}, func(a *Assets) Scene { return NewGuitarScene(a) }},
	{"Guitar Hero", color.RGBA{60, 100, 220, 255}, func(a *Assets) Scene { return NewGuitarScene(a) }},
	{"Space Invaders", color.RGBA{220, 200, 60, 255}, func(a *Assets) Scene { return NewGuitarScene(a) }},
	{"Tetris", color.RGBA{160, 60, 220, 255}, func(a *Assets) Scene { return NewGuitarScene(a) }},
	{"Platformer", color.RGBA{60, 200, 200, 255}, func(a *Assets) Scene { return NewGuitarScene(a) }},
}
...
func NewLauncherScene(assets *Assets) *LauncherScene {
	if whitePx == nil {
		whitePx = ebiten.NewImage(1, 1)
		whitePx.Fill(color.White)
	}
	return &LauncherScene{assets: assets}
}
	...
	case launcherFading:
		...
		if l.fadeAlpha >= 255 {
			...
			if entry.newScene != nil {
				return entry.newScene(l.assets), nil
			}
			return NewChickenScene(l.assets), nil
		}
	}
	return nil, nil
}
